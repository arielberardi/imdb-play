...
export const CACHE_REVALIDATE_CATALOG = 21600; // 6 hours

export const CACHE_REVALIDATE_SEARCH = 900; // 15 minutes

export const CACHE_REVALIDATE_DETAILS = 3600; // 1 hour

export const CACHE_REVALIDATE_TRAILERS = 3600; // 1 hour
